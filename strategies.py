...
class _ReachedStatesSearchStrategyHelper[T]:
    def __init__(self):
...
class BreadthFirstSearchStrategy[T](SearchStrategy[T]):
    def __init__(self):
        super().__init__()
...
class BestFirstSearchStrategy[T](SearchStrategy[T], ABC):
    def __init__(self):
        super().__init__()
...
class UniformCostStrategy[T](BestFirstSearchStrategy[T]):
    def __init__(self):
        super().__init__()
...
class AStarStrategy[T](BestFirstSearchStrategy[T]):
